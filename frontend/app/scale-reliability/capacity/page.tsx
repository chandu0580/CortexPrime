...
import CapacityPanel from "@/components/scale-reliability/capacity-panel"
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger(0.04)} className="mx-auto max-w-[1500px]">
            <motion.div variants={variants.fadeUp} className="mb-4">
              ...
              <div className="flex items-center gap-2 mt-2">
                <BarChart3 className="h-5 w-5 text-[#38B88A]" />
                <h1 className="text-[1.5rem] font-bold tracking-[-0.02em] text-[#111827]">Capacity Planning</h1>
              </div>
              <p className="text-[0.82rem] text-[#6B7280]">Estimate infrastructure requirements for 100 to 10,000 users.</p>
            </motion.div>
            <motion.div variants={variants.fadeUp}><CapacityPanel /></motion.div>
          </motion.div>
        </main>
      </div>
    </div>
