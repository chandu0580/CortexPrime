...
import StressTestingPanel from "@/components/scale-reliability/stress-testing-panel"
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger(0.04)} className="mx-auto max-w-[1500px]">
            <motion.div variants={variants.fadeUp} className="mb-4">
              ...
              <div className="flex items-center gap-2 mt-2">
                <Flame className="h-5 w-5 text-[#38B88A]" />
                <h1 className="text-[1.5rem] font-bold tracking-[-0.02em] text-[#111827]">Stress Testing</h1>
              </div>
              <p className="text-[0.82rem] text-[#6B7280]">Increase workload until limits are reached. Identify breaking points, bottlenecks, and system recommendations.</p>
            </motion.div>
            <motion.div variants={variants.fadeUp}><StressTestingPanel /></motion.div>
          </motion.div>
        </main>
      </div>
    </div>
