...
import PerformancePanel from "@/components/scale-reliability/performance-panel"
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger(0.04)} className="mx-auto max-w-[1500px]">
            <motion.div variants={variants.fadeUp} className="mb-4">
              ...
              <div className="flex items-center gap-2 mt-2">
                <Gauge className="h-5 w-5 text-[#38B88A]" />
                <h1 className="text-[1.5rem] font-bold tracking-[-0.02em] text-[#111827]">Performance Dashboard</h1>
              </div>
              <p className="text-[0.82rem] text-[#6B7280]">Mission throughput, worker throughput, API throughput, latencies, and resource utilization.</p>
            </motion.div>
            <motion.div variants={variants.fadeUp}><PerformancePanel /></motion.div>
          </motion.div>
        </main>
      </div>
    </div>
