...
import { ProductTourPanel } from "@/components/pilot-readiness/product-tour-panel"
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger(0.04)} className="mx-auto max-w-[1500px]">
            <motion.div variants={variants.fadeUp} className="mb-4">
              ...
              <div className="flex items-center gap-2 mt-2">
                <MapPin className="h-5 w-5 text-[#38B88A]" />
                <h1 className="text-[1.5rem] font-bold tracking-[-0.02em] text-[#111827]">Guided Product Tour</h1>
              </div>
              <p className="text-[0.82rem] text-[#6B7280]">Interactive walkthrough covering the Executive Platform, Mission Control, Replay, Certification, Operations, and Developer Portal.</p>
            </motion.div>
            <motion.div variants={variants.fadeUp}><ProductTourPanel /></motion.div>
          </motion.div>
        </main>
      </div>
    </div>
