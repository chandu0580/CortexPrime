...
import WorkersPanel from "@/components/operations-center/workers-panel"
        ...
        <main className="flex-1 px-5 py-5">
          <motion.div initial="hidden" animate="visible" variants={stagger(0.04)} className="mx-auto max-w-[1500px]">
            <motion.div variants={variants.fadeUp} className="mb-4">
              ...
              <h1 className="text-[1.5rem] font-bold tracking-[-0.02em] text-[#111827] mt-2">Workers</h1>
              <p className="text-[0.82rem] text-[#6B7280]">Monitor browser, voice, and desktop workers. Restart, drain, scale, and health checks.</p>
            </motion.div>
            <motion.div variants={variants.fadeUp}><WorkersPanel /></motion.div>
          </motion.div>
        </main>
      </div>
    </div>
