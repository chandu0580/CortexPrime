...
import ModelsPanel from "@/components/operations-center/models-panel"
        ...
        <main className="flex-1 px-5 py-5">
          <motion.div initial="hidden" animate="visible" variants={stagger(0.04)} className="mx-auto max-w-[1500px]">
            <motion.div variants={variants.fadeUp} className="mb-4">
              ...
              <h1 className="text-[1.5rem] font-bold tracking-[-0.02em] text-[#111827] mt-2">AI Models</h1>
              <p className="text-[0.82rem] text-[#6B7280]">Manage providers, routing, fallback, cost policies, rate limits, and usage.</p>
            </motion.div>
            <motion.div variants={variants.fadeUp}><ModelsPanel /></motion.div>
          </motion.div>
        </main>
      </div>
    </div>
